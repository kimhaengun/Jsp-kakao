...
<main class="join__container">
	<div class="main__container">
		<div class="main__box">
		<form action="/kakao/user?cmd=join" method="post">
			...
			<section class="join__box">
				<div style="margin-top: -50px">
					<div class="join__box__email">
						...
						<input class="join__box__input" name="username" type="text" placeholder="아이디 입력" required />
					...
					<div class="join__box__common">
						...
						<input class="join__box__input" name="password" type="text" placeholder="비밀번호 입력" required />
					</div>
					<div class="join__box__common">
						<p class="join__box__impotext">이름</p>
						<input class="join__box__input" name="usernickname" type="text" placeholder="이름 입력" required />
					</div>
					<div class="join__box__common">
						<p class="join__box__impotext">휴대폰번호</p>
						<input class="join__box__input" name="phone" type="text" placeholder="휴대폰번호 입력" required />
					</div>
					<div class="join__box__common">
						<p class="join__box__impotext">주소</p>
						<input class="join__box__input" name="address" type="text" placeholder="주소 입력" required />
					</div>
